	...
	<div
		...
		<div class="main">
			<div class="login">
				...
				<div style="width:180px; margin-left:-75px; height:430px; float:left; background-color:#ebebeb;">
				...
				<a href="Registration.jsp"><img alt="" src="images/register.jpg" style="width:85%;height:230px; margin-left:15px; text-align:left; float:left; color:#6d7676;"></a>	
				</div>
			</div>
			<div class="main2">
				<div class="maincontent_bg">
					<h1 style="width: 100%; text-align: center;">REGISTRATION</h1>
				</div>
				<div
					style="width: 416px; height:420px; float: right; background-color: #ebebeb;">
					<p>
						<center>
						<s:form action="Register" method="post" label="Registration Form"
							key="form" name="MyForm">
							<s:textfield key="r.name" label="Name:" />
							<s:textfield key="r.age" label="Age:" />
							<s:select list="{'MALE','FEMALE'}" key="r.gender"
								label=" Select Gender:" />
							<s:textfield key="r.email" label="Email:" />
							<s:textarea key="r.address" style="width:136px;height:33px;" label="Address:" />
							<s:textfield key="r.mobile" label="Mobile No.:" />
							<s:textfield key="r.username" label="Username:" />
							<s:password key="r.password" label="Password" />
							<s:password key="r.confirmpassword" label="Confirm Password:" />
							<s:submit value="Register" />
						</s:form>
						<br>
						<s:property value="RegistrationSuccess" />
						<s:property value="usernamealreadyexists" />
						<br>
						<s:property value="k" />
					</center>
					</p>
