		...
		<div class="main">
			...
			<div class="main2">
				<div class="maincontent_bg">
					<h1 style="width: 100%; text-align: center;">WELCOME : <b><s:property value="#session.username" /></b></h1>
				</div>
				<div
					style="width: 430px; height: 415px; float: left; background-color: #ebebeb;">
						...
						<br/>
						<img alt="cloud" src="images/home1.png" style="width: 400px; height: 390px;"/>
						</s:if>
						<s:else>
