...
<link rel="stylesheet" href="CSS3 Menu_files/css3menu1/menustyle.css"
	type="text/css" />
<style type="text/css">
._css3m {
	display: none
			...
			<div class="midcontent"
				...
				<div class="nav">
					<img src="images/checkstatus.png"  height="21px" width="21px" class="navicon" /><span class="nav1"><a
						href="#" id="menu1">Check Status</a></span> <img src="images/booknow.png"
						class="navicon"  height="21px" width="21px" /><span class="nav1"><a href="#"
						...
						href="#" id="menu3">History</a></span> <img src="images/logout1.png" height="21px" width="21px"
						class="navicon" /><span class="nav1"><a href="#" id="menu4">Logout
							</a></span>
				</div>
			</div>
				<div
