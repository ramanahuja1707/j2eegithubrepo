		...
		<s:if test="#session.EmpNo!=null">
			...
			<table style="width: 25%; height: AUTO; background-color: #ffc">
				<tr>
					<td>Employee Name:</td>
					<td><input type="text"
						value="<s:property value="#session.ed1.EmpName"/>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td>Designation:</td>
					<td><input type="text"
						value="<s:property value="#session.ed1.EmpDesig"/>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td>Grade:</td>
					<td><input type="text"
						value="<s:property value="#session.ed1.EmpGrade"/>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td>Department:</td>
					<td><input type="text"
						value="<s:property value="#session.ed1.EmpDept"/>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td>Employee No.:</td>
					<td><input type="text" value="<s:property value="#session.ed1.Empno"/>"
				...
				<tr>
					<td>Employee Unit:</td>
					<td><input type="text"
						value="<s:property value="#session.ed1.EmpUnit"/>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td>Office Contact:</td>
					<td><input type="text"
						value="<s:property value="#session.ed1.EmpContact"/>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td>Employee Email:</td>
					<td><input type="text"
						value="<s:property value="#session.ed1.EmpEmail"/>" disabled="disabled" /></td>
				</tr>
			</table>
			<br />
			<center>
				<img src="images/logout1.png" height="21px" width="21px"
					class="navicon" /><a href="logout" id="menu4">Logout </a>
			</center>
			...
			<div class="midcontent"
				style="width: 60%; float: right; margin-right: 150px; height: 400px;">
				<div class="midcontent_box" style="background-color: #ffdb94">
					<div class="nav">
						<img src="images/checkstatus.png" height="21px" width="21px"
							class="navicon" /><span class="nav1"><a href="CheckStatus.jsp"
							id="menu1">Check Status</a></span> <img src="images/booknow.png"
							class="navicon" height="21px" width="21px" /><span class="nav1"><a
							href="BookNow" id="menu2">Book Now</a></span> <img
							src="images/history1.png" height="21px" width="21px"
							class="navicon" height="21px" width="21px" /><span class="nav1"><a
							href="ShowRejectedRequests" id="menu3">Rejected</a></span> <img
							src="images/approved.jpg" height="21px" width="21px"
							class="navicon" /><span class="nav1"><a
							href="ShowApprovedRequests" id="menu4">Approved </a></span>
					</div>
				</div>
				<div
					...
					<s:textfield name="RequestNo" label="Enter Request No."/>
					<s:submit value="Check Status"/>
					</s:form>
					<br /> <br /> <br /><h2>
