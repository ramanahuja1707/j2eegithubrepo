...
<body>
	<s:if test="#session.username!=null">
		...
		<div class="main">
			...
			<s:if test="#session.username!=null">
				<s:if test="obtainedprofile.size!=null">
					<center>
						<form action="editprofile" method="post">
							<s:iterator var="e" value="obtainedprofile">
				NAME:<input type="text" disabled="disabled" id="td1"
									value="<s:property value="#e.name" />" name="c.name" />
								<br>
								<br>
				USERNAME:<s:property value="#e.username" />
								<br>
								<br>
				AGE:<s:property value="#e.age" />
								<br>
								<br>
				GENDER:<s:property value="#e.gender" />
								<br>
								<br>
				EMAIL:<s:property value="#e.email" />
								<br>
								<br>
				PASSWORD:<input type="text" disabled="disabled" id="td2"
									value="<s:property value="#e.password"/>" name="password" />
								<br>
								<br>
								<input type="button" value="EDIT" onclick="return enable()" />
								<br>
