		...
		<div class="main">
			...
			<div class="main2">
				<div class="maincontent_bg">
					<h1 style="width: 100%; text-align: center;">PRINT TEXT
					</h1>
				</div>
				<div
						...
						<p style="margin-left: 90px; width: 190px;">
							<s:if test="#session.username!=null">
								<form action="print" method="post">
									<table cellspacing="0px" border="2px" style="width: 430px;">
										<tr>
											<td><b><i>SELECT</b></i></td>
											<td><b><i>NAME</b></i></td>
											<td align="center"><b><i>STATUS</b></i></td>
											<td align="center"><b><i>DATE OF UPLOADED</b></i></td>
										</tr>
										<s:iterator var="e" value="receiveddata">
											<tr>
												<td><center>
														<input type="radio" value="<s:property value="#e.name" />"
															name="obtainedfilename" />
													</center></td>
												<td><center>
