		...
		<s:if test="#session.EmpNo!=null">
			...
			<div class="midcontent"
				...
				<div
					...
					<br /> Request No:
					<s:property value="rtc.Empno" />
					<br /> Employee Name :
					<s:property value="rtc.EmpName" />
					<br /> Car Reporting Date:
					<s:property value="rtc.CarReportingDate" />
					<br /> Car Reporitng Time :
					<s:property value="rtc.CarReportingTime" />
					<br /> Car Name :
					<s:property value="rtc.CarName" />
					<br /> Car Type:
					<s:property value="rtc.CarType" />
					<br /> Trip (In kms):
					<s:property value="rtc.TripInKms" />
					<br /> Drop At Station:
					<s:property value="rtc.DropAtStation" />
					<br /> Car No.:
					<s:property value="cad.CarName" />
					<br /> Driver Name:
					<s:property value="cad.DriverName" />
					<br /> Driver Contact:
					<s:property value="cad.DriverContact" />
					<br /> <br /> <br />
				</div>
			</div>
		</s:if>
