	...
	<div
		...
		<div class="main">
			<div class="login">
				...
				<a href="Registration.jsp"><img alt="" src="images/register.jpg" style="width:85%;height:220px; margin-left:15px; text-align:left; float:left; color:#6d7676;"></a>	
				</div>
			</div>
			<div class="main2">
				...
				<div
					...
					<p>
					<b><font style="color:#84D7FD;"><i>THANK YOU FOR YOUR SUPPORT, YOUR ACCOUNT PASSWORD SENT SUCCESSFULLY ON YOUR EMAIL-ID :-)</i></font></b>
					<br/><br/>
					<img alt="Thank You" src="images/thankyou.jpg" style="width: 380px;height:200px;">
					</p>
				</div>
			</div>
		</div>
