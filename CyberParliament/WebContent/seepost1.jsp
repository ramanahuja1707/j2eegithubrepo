				...
				<s:iterator var="e" value="posttohome">
					<div
						...
						<form action="like" method="post">
							...
							<input type="submit" value="like" id="likesubmit" style="display: none;"/>
						</form>
						(
						<s:property value="#e.likes"/>-People liked
						)<br><form action="unlike" method="post" onsubmit="return disableunlike()"><input type="radio"
							value="<s:property value="#e.post"/>" name="post" id="unlike"
							checked="checked" style="display: none;" />
							<input type="submit" value="unlike" id="unlikesubmit"> </form>
