				...
				<div class="midcontent_box">
					<div class="nav">
						<img src="images/checkstatus.png" height="21px" width="21px"
							...
							class="navicon" /><span class="nav1"><a href="ShowApprovedRequests"
							id="menu4">Approved </a></span>
					</div>
				</div>
				<div
					...
					PLEASE FILL CONVIENCE DETAILS ! <br />
					...
					<br /> <font style="color: red;"><s:property
							value="ValidateFieldStatus" />Booking Request Sent !!! <s:property
							value="RequestCheck" /></font>
				</div>
			</div>
		</s:if>
		<s:else>
