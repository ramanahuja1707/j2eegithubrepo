...
public class showpdffiles extends ActionSupport implements SessionAware {
	...
	public String execute() throws Exception {
		...
		Query queryResult = ses
				.createQuery("from filedata where id='"
						+ obtainedusername +"_"+obtainedpassword+ "'and filetype='"+"pdf"+"'");
		List<filedata> Users;
		Users = (List<filedata>) queryResult.list();
		if(Users.size()==0)
			return "nodatafound";
