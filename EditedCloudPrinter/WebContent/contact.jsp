		...
		<div class="main">
			<div class="login">
				...
				<div class="loginbox">
					...
					<a href="Registration.jsp"><img alt=""
			...
			<div class="main2">
				<div class="maincontent_bg">
					<h1 style="width: 100%; text-align: center;">CONTACT</h1>
				</div>
				<div
					...
					<center>
						<b><i>E- MAIL
								:-nitika.rattan.03@gmail.com</b> </i>
					</center><BR/>
					<h2 style="width: 95%; text-align: center;">
						<i>Tanya Bansal</i>
					</h2>
					<center>
						<b><i>E- MAIL
								:-tanyabansal14@gmail.com</b> </i>
					</center>
					<BR/>
					<h2 style="width: 95%; text-align: center;">
						<i>Pratibha Varshney</i>
					</h2>
					<center>
						<b><i>E- MAIL
								:-pratibhavarshney99@gmail.com</b> </i>
					</center>
					<br /> <br />
					</p>
				</div>
