	...
	<div class="main">
		<s:if test="#session.EmpNo!=null">
			...
			<div class="midcontent"
				...
				<br/>
				<form action="CheckDetails" method="post" id="MyForm">
						<table cellspacing="0px" border="2px" style="width: 800px;">
							...
							<s:iterator var="e" value="ApprovedRequests">
								<tr>
									<td><center>
											<input type="radio" value="<s:property value="#e.Empno"/>"
												name="requestno" id="select" />
										</center></td>
									<td><center>
						...
						<br/>
						<input type="submit" value="Check Details" id="submit" style="float: right;"/>
						</form>
				 <br />
				 <s:property value="checkDetailsValidationError"/>
			</div>
			</div>
		</s:if>
		<s:else>
