	...
	<div
		...
		<div class="main">
			<div class="login">
				...
				<div class="loginbox">
					<img src="images/cloudprinthost.png" alt="Cloud Print" style="height: 140px; width: 180px;"/>
			<sj:menu id="menuWithItems" cssStyle="background-color:#ebebeb;height:auto;">
			<sj:menuItem title="Create Files" 
				href="upload.jsp" cssStyle="background-color:#ebebeb;"/>
			<sj:menuItem title="Open Files" cssStyle="background-color:#ebebeb;">
				<sj:menu id="subMenuPlugins" cssErrorStyle="background-color:#ebebeb;">
					<sj:menuItem title="Text"
						href="showfiles" />
				</sj:menu>
			</sj:menuItem>
			<sj:menuItem title="Upload Files" cssStyle="background-color:#ebebeb;">
				<sj:menu id="" cssStyle="width:auto;background-color:#ebebeb;">
					<sj:menuItem title="Text"
						href="uploadtextfile.jsp" />
					<sj:menuItem title="Image"
						href="fileuploadformat.jsp" />
					<sj:menuItem title="Pdf"
						href="uploadpdf.jsp" />
				</sj:menu>
			</sj:menuItem>
		...
		<img src="images/cloudprint.png" alt="Cloud Print" style="height: 140px; width: 180px;"/>
				</div>
			</div>
			<br/><br/><br/><br/><br/><br/><br/><br/>
			<div class="content">
				<s:if test="#session.username!=null">
					<s:form action="upload" method="post" style="width:100%;height:auto;">
						<s:textarea key="f.data" label="Enter text:"
							style="width: 600px; height: 236px;" />
						<s:textfield key="f.name" label="Name of File:" />
						<s:submit />
						<s:reset />
					</s:form>
					<br>
